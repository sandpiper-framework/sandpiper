...
VALUES
    ('10000000-0000-0000-0000-000000000000', 'Primary Company', 'https://sandpiper.example.com', true,  now(), now());


INSERT INTO users (
    id, first_name, last_name, username, password, email, phone, active, role, company_id, created_at, updated_at)
VALUES
    (1, 'Admin', 'Admin', 'admin', '$2a$10$jlCjsODRzvR3L4NVAI6z3uULAAaqMOSadVRWaUJjwtp.cK1huLFlK', 'admin@mail.com',
