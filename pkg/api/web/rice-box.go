...
func init() {
	...
	file8 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1597853756, 0),
	...
	dir7 := &embedded.EmbeddedDir{
		Filename:   "css",
		DirModTime: time.Unix(1597853756, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file8, // "css/style.css"
	...
	dir9 := &embedded.EmbeddedDir{
		...
		ChildFiles: []*embedded.EmbeddedFile{
			filea, // "img/favicon-16x16.png"
			fileb, // "img/favicon-32x32.png"
			filec, // "img/logo.svg"
	...
	embedded.RegisterEmbeddedBox(`static`, &embedded.EmbeddedBox{
		...
		Files: map[string]*embedded.EmbeddedFile{
			"css/style.css":         file8,
			"img/favicon-16x16.png": filea,
			"img/favicon-32x32.png": fileb,
			"img/logo.svg":          filec,
		},
	})
}
